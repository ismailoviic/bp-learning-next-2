...
export const counterQuestions = [
  ...
  },
  {
    ...
    allowUnknown: true,
    showWhen: (answers) => !!answers.find((a) => a.questionId === "q_who"),
    quickAnswers: [
      "Non, rien encore",
      "Oui, sans résultat",
      "Oui, ça a un peu aidé",
      "Oui, mais les symptômes reviennent",
    ],
  },
  {
    id: "q_other_products",
    ...
    allowUnknown: true,
    showWhen: (answers) => !!answers.find((a) => a.questionId === "q_tried"),
    quickAnswers: [
      "Non",
      "Oui, des médicaments prescrits",
      "Oui, des compléments alimentaires",
      "Oui, plusieurs (médicaments + compléments)",
    ],
  },
];
...
export function decide(input) {
  ...
  if (needHasMed || entriesHaveMed || customerHasOtherMeds) {
    const upsellItems = matchUpsellsForEntries(entries);
